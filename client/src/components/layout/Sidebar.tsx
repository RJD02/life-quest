...
const navigation = [
  ...
  { name: 'Sprints', href: '/sprints', icon: TrophyIcon, iconSolid: TrophyIconSolid },
          ...
          return (
            <Link
              ...
              style={{
                ...
                color: isActive ? 'var(--color-primary-foreground)' : 'var(--color-sidebar-foreground)'
              }}
              onMouseOver={(e) => {
                if (!isActive) {
            ...
            >
              ...
              <Icon
                className={`relative z-10 w-5 h-5 flex-shrink-0 ${isCollapsed ? 'mx-auto' : 'mr-3'}`}
                style={{ 
                  color: isActive ? 'var(--color-primary-foreground)' : 'var(--color-sidebar-foreground)'
                }}
              />
